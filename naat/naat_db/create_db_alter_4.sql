...
-- AUTO INCREMENT
CREATE SEQUENCE "Decision_Type_Id_seq";

CREATE TABLE Decision_Type (
    Decision_Type_Id INTEGER PRIMARY KEY NOT NULL DEFAULT nextval('"Decision_Type_Id_seq"'::regclass),
    Name TEXT NOT NULL,

    created_at TIMESTAMP NOT NULL DEFAULT NOW(),
    updated_at TIMESTAMP NOT NULL DEFAULT NOW(),

    CONSTRAINT UX_Decision_Type_Name UNIQUE (Name)
);

-- AUTO INCREMENT
ALTER SEQUENCE "Decision_Type_Id_seq" owned by Decision_Type.Decision_Type_Id;

-- CREATE FUNCTION
CREATE OR REPLACE FUNCTION "function_Decision_Type_updated_at"() 
RETURNS trigger
LANGUAGE plpgsql
AS $function$
begin
...
-- CREATE TRIGGER
CREATE TRIGGER "trigger_Decision_Type_updated_at" 
BEFORE UPDATE
ON Decision_Type FOR EACH ROW
EXECUTE FUNCTION "function_Decision_Type_updated_at"();
...
/*
#############
Legal_Decision Table
#############
*/

-- AUTO INCREMENT
CREATE SEQUENCE "Legal_Decision_Id_seq";

CREATE TABLE Legal_Decision (
    Legal_Decision_Id INTEGER PRIMARY KEY NOT NULL DEFAULT nextval('"Legal_Decision_Id_seq"'::regclass),
    ...
    FOREIGN KEY(Decision_Type_Id) REFERENCES Decision_Type(Decision_Type_Id) ON DELETE RESTRICT,
    FOREIGN KEY(Jurisdiction_Id) REFERENCES Jurisdiction(Jurisdiction_Id) ON DELETE RESTRICT,

    CONSTRAINT UX_Legal_Decision_TitleLegalCase UNIQUE (Legal_Case_Id, Title)
);

-- AUTO INCREMENT
ALTER SEQUENCE "Legal_Decision_Id_seq" owned by Legal_Decision.Legal_Decision_Id;

-- CREATE FUNCTION
CREATE OR REPLACE FUNCTION "function_Legal_Decision_updated_at"() 
RETURNS trigger
LANGUAGE plpgsql
AS $function$
begin
...
-- CREATE TRIGGER
CREATE TRIGGER "trigger_Legal_Decision_updated_at" 
BEFORE UPDATE
ON Legal_Decision FOR EACH ROW
EXECUTE FUNCTION "function_Legal_Decision_updated_at"();
...
/*
#############
Legal_Decision_Resource Table
#############
*/

-- AUTO INCREMENT

CREATE TABLE Legal_Decision_Resource (
    Resource_Id INT NOT NULL,
    Legal_Decision_Id INT NOT NULL,
    ...
    FOREIGN KEY(Legal_Decision_Id) REFERENCES Legal_Decision(Legal_Decision_Id) ON DELETE RESTRICT,

    PRIMARY KEY(Resource_Id, Legal_Decision_Id)
);

-- CREATE FUNCTION
CREATE OR REPLACE FUNCTION "function_Legal_Decision_Resource_updated_at"() 
RETURNS trigger
LANGUAGE plpgsql
AS $function$
begin
...
-- CREATE TRIGGER
CREATE TRIGGER "trigger_Legal_Decision_Resource_updated_at" 
BEFORE UPDATE
ON Legal_Decision_Resource FOR EACH ROW
EXECUTE FUNCTION "function_Legal_Decision_Resource_updated_at"();
...
/*
#############
Legal_Decision_Ground Table
#############
*/

CREATE TABLE Legal_Decision_Ground (
    ...
    PRIMARY KEY(Ground_Id, Legal_Decision_Id)
);

-- CREATE FUNCTION
CREATE OR REPLACE FUNCTION "function_Legal_Decision_Ground_updated_at"() 
RETURNS trigger
LANGUAGE plpgsql
AS $function$
begin
...
-- CREATE TRIGGER
CREATE TRIGGER "trigger_Legal_Decision_Ground_updated_at" 
BEFORE UPDATE
ON Legal_Decision_Ground FOR EACH ROW
EXECUTE FUNCTION "function_Legal_Decision_Ground_updated_at"();
...
*/
INSERT INTO Decision_Type (Name) VALUES ('Demandes accueillies');
INSERT INTO Decision_Type (Name) VALUES ('Rejet');
INSERT INTO Decision_Type (Name) VALUES ('Ne statue pas sur le fond');
INSERT INTO Decision_Type (Name) VALUES ('Demande partiellement accueillies');
...
/* PREFIX_CODE varchar := 'nc_05yt___'; */

ALTER TABLE Decision_Type RENAME TO                     "nc_05yt___Decision_Type";
ALTER TABLE Legal_Decision RENAME TO                    "nc_05yt___Legal_Decision";
ALTER TABLE Jurisdiction RENAME TO                      "nc_05yt___Jurisdiction";
ALTER TABLE Ground_Type RENAME TO                       "nc_05yt___Ground_Type";
ALTER TABLE Ground RENAME TO                            "nc_05yt___Ground";
ALTER TABLE Case_Status RENAME TO                       "nc_05yt___Case_Status";
ALTER TABLE Agent_Type RENAME TO                        "nc_05yt___Agent_Type";
ALTER TABLE Agent RENAME TO                             "nc_05yt___Agent";
ALTER TABLE Appeal_Type RENAME TO                       "nc_05yt___Appeal_Type";
ALTER TABLE Legal_Case RENAME TO                        "nc_05yt___Legal_Case";
ALTER TABLE Resource_Type RENAME TO                     "nc_05yt___Resource_Type";
ALTER TABLE Resource RENAME TO                          "nc_05yt___Resource";
ALTER TABLE Legal_Decision_Resource RENAME TO           "nc_05yt___Legal_Decision_Resource";
ALTER TABLE Legal_Case_Complainant RENAME TO            "nc_05yt___Legal_Case_Complainant";
ALTER TABLE Legal_Case_Complainant_Recipient RENAME TO  "nc_05yt___Legal_Case_Complainant_Recipient";
ALTER TABLE Legal_Decision_Ground RENAME TO             "nc_05yt___Legal_Decision_Ground";
...
BEFORE DELETE
ON "nc_05yt___Legal_Case_Complainant"
FOR EACH ROW
...
BEFORE DELETE
ON "nc_05yt___Legal_Case_Complainant_Recipient"
FOR EACH ROW
EXECUTE FUNCTION function_many_to_many_agent_temp_blocking();
...
BEFORE DELETE
ON "nc_05yt___Legal_Decision_Resource"
FOR EACH ROW
EXECUTE FUNCTION function_many_to_many_agent_temp_blocking();
...
BEFORE DELETE
ON "nc_05yt___Legal_Decision_Ground"
FOR EACH ROW
EXECUTE FUNCTION function_many_to_many_agent_temp_blocking();



DROP TRIGGER trigger_many_to_many_agent_complainant ON "nc_05yt___Agent";
...
ALTER TABLE                     "nc_05yt___Decision_Type" RENAME TO Decision_Type                   ;
ALTER TABLE                    "nc_05yt___Legal_Decision" RENAME TO Legal_Decision                  ;
...
ALTER TABLE           "nc_05yt___Legal_Decision_Resource" RENAME TO Legal_Decision_Resource         ;
...
ALTER TABLE             "nc_05yt___Legal_Decision_Ground" RENAME TO Legal_Decision_Ground           ;
