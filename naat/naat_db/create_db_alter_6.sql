...
/*
delete from "nc_05yt___Case_Complainant" 
where "agent_id" = (select "agent_id" from "nc_05yt___Agent" where "agent_id" = $1 limit $2) 
    and "case_id" = (select "case_id" from "nc_05yt___Case" where "case_id" = $3 limit $4) - Cannot delete !!!
*/
