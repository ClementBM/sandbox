...
/* PREFIX_CODE varchar := 'nc_s_3l___'; */

ALTER TABLE Final_Decision RENAME TO                    "nc_s_3l___Final_Decision";
ALTER TABLE Jurisdiction RENAME TO                      "nc_s_3l___Jurisdiction";
ALTER TABLE Ground_Type RENAME TO                       "nc_s_3l___Ground_Type";
ALTER TABLE Ground RENAME TO                            "nc_s_3l___Ground";
ALTER TABLE Case_Status RENAME TO                       "nc_s_3l___Case_Status";
ALTER TABLE Agent_Type RENAME TO                        "nc_s_3l___Agent_Type";
ALTER TABLE Agent RENAME TO                             "nc_s_3l___Agent";
ALTER TABLE Appeal_Type RENAME TO                       "nc_s_3l___Appeal_Type";
ALTER TABLE Legal_Case RENAME TO                        "nc_s_3l___Legal_Case";
ALTER TABLE Resource_Type RENAME TO                     "nc_s_3l___Resource_Type";
ALTER TABLE Resource RENAME TO                          "nc_s_3l___Resource";
ALTER TABLE Legal_Case_Resource RENAME TO               "nc_s_3l___Legal_Case_Resource";
ALTER TABLE Legal_Case_Complainant RENAME TO            "nc_s_3l___Legal_Case_Complainant";
ALTER TABLE Legal_Case_Complainant_Recipient RENAME TO  "nc_s_3l___Legal_Case_Complainant_Recipient";
ALTER TABLE Legal_Case_Ground RENAME TO                 "nc_s_3l___Legal_Case_Ground";
